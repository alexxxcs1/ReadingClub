    ...
    return (
      <div className={style.OutBox} >
        ...
        <div className={style.Introduce}>
          ...
          <span>,为响应2019年"5·12"国际护士节主题,中护在线推出</span>
          <span className={style.FontBold}>主题读书会活动</span>
          <span>
           ,特别选取了较受护士们欢迎的6本书籍作为分享蓝本,或您也可以上传想推荐给同仁的与护理有关书籍,摘取该书其中一段或章节,分享所选内容的<span className={style.FontBold}>临床宝贵经验、真实案例讨论或护患真情故事</span>,并上传其中任意一个题材的演说视频。
          </span>
        </div>
