  ...
  return (
    <div className={style.ViewBox}>
        <div className={style.NoticeBox}>
            <div className={style.ItemBox}>
                ...
                <div className={[style.DropBox,this.state.onShow == 'rule'?style.onShow:''].join(' ')}>
                    <div className={style.RuleContent}>
                        <p><span className={style.UnderLine}>参赛时间</span>：2019年5月12日至6月12日</p> 
            ...
            <div className={[style.ItemBox,'childcenter childcolumn childcontentstart'].join(' ')}>
                ...
                <div className={[style.DropBox,style.WideBox,this.state.onShow == 'awards'?style.onShow:''].join(' ')}>
                    <img src={award} className={style.AwardBox} alt=""/>
                </div>
            </div>
        </div>
    </div>
